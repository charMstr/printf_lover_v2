...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/12/13 18:58:32 by charmstr          #+#    #+#             */
/*   Updated: 2019/12/13 18:58:38 by charmstr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		assert_test_func_c(int c);
int		assert_test_func_s(const char *s);
int		assert_test_func_p(void *p);
int		assert_test_func_d(int d);
int		assert_test_func_i(int i);
int		assert_test_func_u(unsigned int u);
int		assert_test_func_x(unsigned int x);
int		assert_test_func_X(unsigned int X);
int     assert_test_func_percent(void);

int		assert_test_func_n(int n);
int		assert_test_func_f(double f);
int		assert_test_func_g(double g);
int		assert_test_func_e(double e);

int     assert_test_func_hi(short int hi);
int     assert_test_func_hx(short int hx);
int     assert_test_func_hu(short int hu);
int     assert_test_func_hhi(signed char hhi);
int     assert_test_func_hhx(signed char hhx);
int     assert_test_func_hhu(signed char hhu);

int     assert_test_func_li(long int li);
int     assert_test_func_lx(long int lx);
int     assert_test_func_lu(long int lu);
int     assert_test_func_lli(long long int lli);
int     assert_test_func_llx(long long int llx);
int     assert_test_func_llu(long long int llu);
